    ...
    async def execute(
        ...
        **kwargs
        ...
        try:
            ...
            app_logger.info(f"Executing {self.name}", preferences=preferences)
            ...
            app_logger.info(f"Success: {self.name}", matches=len(suggestions))
            ...
            app_logger.error(f"Error in {self.name}", exception=e)
            return {
                "suggestions": [],
                "total_matches": 0,
